...
import (
	...
	"github.com/masonictemple4/proglog/internal/auth"
	"github.com/masonictemple4/proglog/internal/config"
	"github.com/masonictemple4/proglog/internal/log"
...
// When a test file implements this TestMain(m *testing.M) function, go will call it,
// instead of running the tests directly. It gives us a place for setup that applies to all
// tests in the file, like enabling our debug output. Flag parsing has to go here, otherwise
// Go can't define the flag and we'll get an error.
...
func setupTest(t *testing.T, fn func(*Config)) (rootClient api.LogClient, nobodyClient api.LogClient, cfg *Config, teardown func()) {
	...
	return rootClient, nobodyClient, cfg, func() {
		...
		if telemetryExporter != nil {
			// Sleep for 1.5 seconds to give the exporter enough time to flush it's data to disk.
